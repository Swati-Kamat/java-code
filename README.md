# java-code
The super keyword in Java is a reference variable used within a subclass to refer to the immediate parent (superclass) object. It is primarily used in inheritance to access members (variables, methods, and constructors) of the parent class when they are hidden or overridden by the subclass. 
